...
export default function Hero() {
  return (
    <section className="mt-18 relative min-h-screen w-full flex flex-col justify-between p-6 md:p-12 overflow-hidden bg-white text-[#0a0a0a]">
      ...
      <div className="relative z-10 mt-12 md:mt-0">
        {/* The "Brutalist" Heading - Now in Solid Black / Outline */}
        <h1 className="text-[16vw] font-black leading-[0.75] tracking-tighter uppercase select-none text-[#0a0a0a]">
          Solid <br /> 
          <span 
